...
namespace DioLive.Cache.Storage.SqlServer
{
	...
	{
		internal static async Task<Result> CheckUserRightsForBudget(Guid budgetId, string userId, ShareAccess requiredAccess, IDbConnection connection)
		{
		...
		internal static async Task<Result> CheckUserRightsForCategory(int categoryId, string userId, ShareAccess requiredAccess, IDbConnection connection)
		{
		...
		internal static async Task<Result> CheckUserRightsForPurchase(Guid purchaseId, string userId, ShareAccess requiredAccess, IDbConnection connection)
		{
