...
gulp.task("bootstrap-datepicker",
    ["bootstrap-datepicker:css", "bootstrap-datepicker:js", "bootstrap-datepicker:locales"]);

gulp.task("bootstrap-slider", ["bootstrap-slider:css", "bootstrap-slider:js"]);

gulp.task("bootstrap-colorpicker",
    ["bootstrap-colorpicker:css", "bootstrap-colorpicker:img", "bootstrap-colorpicker:js"]);

gulp.task("bootstrap",
    ["bootstrap:core", "bootstrap3-typeahead", "bootstrap-datepicker", "bootstrap-slider", "bootstrap-colorpicker"]);

gulp.task("d3", ["d3:js", "d3charts:less"]);

gulp.task("default", ["jquery", "bootstrap", "textarea-autosize", "site:less", "bootstrap-override", "d3"]);