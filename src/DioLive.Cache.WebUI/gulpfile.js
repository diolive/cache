...
gulp.task("jquery:core",
    function() {
        return gulp.src("node_modules/@bower_components/jquery/dist/jquery.js")
            .pipe(gulp.dest("wwwroot/js/lib"));
    });

gulp.task("jquery-validation",
    function() {
        return gulp.src("node_modules/@bower_components/jquery-validation/dist/*.js")
            .pipe(gulp.dest("wwwroot/js/lib"));
    });

gulp.task("jquery-validation-unobtrusive",
    function() {
        return gulp.src("node_modules/@bower_components/jquery-validation-unobtrusive/jquery.validate.unobtrusive.js")
            .pipe(gulp.dest("wwwroot/js/lib"));
    });
...
gulp.task("bootstrap:js",
    function() {
        return gulp.src("node_modules/@bower_components/bootstrap/dist/js/bootstrap.js")
            .pipe(gulp.dest("wwwroot/js/lib"));
    });
...
gulp.task("bootstrap3-typeahead",
    function() {
        return gulp.src("node_modules/@bower_components/bootstrap3-typeahead/bootstrap3-typeahead.js")
            .pipe(gulp.dest("wwwroot/js/lib"));
    });

gulp.task("bootstrap-datepicker:css",
    function() {
        return gulp.src("node_modules/@bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker3.css")
            .pipe(gulp.dest("wwwroot/css"));
    });

gulp.task("bootstrap-datepicker:js",
    function() {
        return gulp.src("node_modules/@bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.js")
            .pipe(gulp.dest("wwwroot/js/lib"));
    });

gulp.task("bootstrap-datepicker:locales",
    function() {
        return gulp.src("node_modules/@bower_components/bootstrap-datepicker/dist/locales/*.js")
            .pipe(gulp.dest("wwwroot/js/lib/locales"));
    });

gulp.task("bootstrap-slider:css",
    function() {
        return gulp.src("node_modules/@bower_components/seiyria-bootstrap-slider/dist/css/bootstrap-slider.css")
            .pipe(gulp.dest("wwwroot/css"));
    });

gulp.task("bootstrap-slider:js",
    function() {
        return gulp.src("node_modules/@bower_components/seiyria-bootstrap-slider/dist/bootstrap-slider.js")
            .pipe(gulp.dest("wwwroot/js/lib"));
    });

gulp.task("textarea-autosize",
    function() {
        return gulp.src("node_modules/@bower_components/textarea-autosize/dist/jquery.textarea_autosize.js")
            .pipe(gulp.dest("wwwroot/js/lib"));
    });
...
gulp.task("bootstrap-colorpicker:css",
    function() {
        return gulp.src("node_modules/@bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.css")
            .pipe(gulp.dest("wwwroot/css"));
    });

gulp.task("bootstrap-colorpicker:img",
    function() {
        return gulp.src("node_modules/@bower_components/bootstrap-colorpicker/dist/img/**/*")
            .pipe(gulp.dest("wwwroot/img"));
    });

gulp.task("bootstrap-colorpicker:js",
    function() {
        return gulp.src("node_modules/@bower_components/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.js")
            .pipe(gulp.dest("wwwroot/js/lib"));
    });

gulp.task("d3:js",
    function() {
        return gulp.src("node_modules/@bower_components/d3/d3.js")
            .pipe(gulp.dest("wwwroot/js/lib"));
    });
